...
const TABS: TabConfig[] = [
  { id: "news", label: "AI News", testId: "tab-news", icon: "📰" },
  { id: "video", label: "Videos & Demos", testId: "tab-video", icon: "🎬" },
  { id: "unlock", label: "Market Unlocks", testId: "tab-unlock", icon: "🔓" },
  { id: "workflow", label: "Best Way to Work", testId: "tab-workflow", icon: "⚡" },
];
